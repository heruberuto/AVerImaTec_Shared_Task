...
init_ques_gen_prompt_first += (
    "Here is the image-text claim. The textual part is: %s Here is the list of images of the claim: "
)
...
init_ques_gen_prompt = {"first": init_ques_gen_prompt_first, "second": init_ques_gen_prompt_second}

follow_ques_gen_prompt_first = "You are a fact-checker to ask questions to verify an image-text claim. "
follow_ques_gen_prompt_first += (
...
follow_ques_gen_prompt = {"first": follow_ques_gen_prompt_first, "second": follow_ques_gen_prompt_second}
...
para_ques_prompt += (
    "For each question, please also indicate it is Text-related or Image-related before the question. "
)
