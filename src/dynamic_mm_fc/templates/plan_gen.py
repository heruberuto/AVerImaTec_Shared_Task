...
plan_gen_prompt += (
    "Question: When was the image taken? Image index: 1. Question type: Image-related Tool option: A\n"
)
...
plan_gen_prompt += (
    "Question: Did Prince Philip pretend to be the palace guard? Question type: Text-related Tool option: D\n"
)
