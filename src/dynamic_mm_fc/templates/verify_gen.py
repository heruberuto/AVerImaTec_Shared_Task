...
verify_gen_prompt += (
    "Refuted: The claim (either the text or the image part) is contradicted by the evidence presented.\n"
)
verify_gen_prompt += (
    "Not Enough Evidence: There is not enough evidence (NEE) to support or refute the claim.\n"
)
